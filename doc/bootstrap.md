...
### Download the Blockchain from the BitcoinLoveNode Project

The BitcoinLove node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by BitcoinLoveNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.bitcoinlovenode.org/bootstrap.dat](http://mango.bitcoinlovenode.org/bootstrap.dat)
* [http://apple.bitcoinlovenode.org/bootstrap.dat](http://apple.bitcoinlovenode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.bitcoinlovenode.org/bootstrap.dat](http://bootstrap.bitcoinlovenode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.bitcoinlovenode.org/bootstrap.dat       //downloads bootstrap into current directory
