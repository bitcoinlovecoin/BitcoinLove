...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("BitcoinLove Core bitcoinlove-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinlove-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinlove transaction") + "\n" +
              "  bitcoinlove-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinlove transaction") + "\n" +
              "\n";
