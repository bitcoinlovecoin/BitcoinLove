...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0256a044fb2aa44ed624e12a01b1d6a6430f1e6c94f68c4598b12d143563511d8f");
        nDefaultPort = 4995;
        ...
        nMinerThreads = 0;
        nTargetTimespan =  6 * 10 * 30; // 30 minutes
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1570914369;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 290075;
		hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xde719419140d33a3397d281e31ecc163b89782647898c8a3f1c1a33c9afca7d1"));
        
	    vSeeds.push_back(CDNSSeedData("Bitcoinlove1", "157.230.234.208"));
        vSeeds.push_back(CDNSSeedData("Bitcoinlove", "167.99.54.126"));
        ...
        // BitcoinLove: Mainnet v2 enforced as of block 710k
...
//        hashGenesisBlock = genesis.GetHash();
  //      assert(hashGenesisBlock == uint256("0xf5ae71e26c74beacc88382716aced69cddf3dffff24f384e1808905e0188f68f"));
        ...
        // BitcoinLove: Testnet v2 enforced as of block 400k
...
//        hashGenesisBlock = genesis.GetHash();
  //      nDefaultPort = 19444;
    //    assert(hashGenesisBlock == uint256("0x530827f38f93b43ed12af0b3ad25a288dc02ed74d6d7857862df51fc56c416f9"));
        ...
        // BitcoinLove: v2 enforced using Bitcoin's supermajority rule
